...
export const Hero = () => {
    ...
    return (
        <section
            ...
            className='relative flex min-h-screen items-center overflow-hidden bg-[#080808] pt-16'
        >
            ...
            <motion.div
                className='absolute left-1/2 top-1/2 hidden h-130 w-130 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/5 lg:block'
                animate={{ rotate: 360 }}
            ...
            <div className='relative z-10 mx-auto grid max-w-7xl items-center gap-12 px-6 py-24 lg:grid-cols-2'>
                ...
                >
                    <motion.div
                        ...
                        className='mb-8 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.06] px-4 py-1.5 text-sm text-white/60 shadow-[0_0_40px_rgba(234,179,8,0.08)] backdrop-blur-xl'
                    >
                    ...
                    <motion.h1
                        ...
                        className='font-display mb-6 bg-linear-to-br from-white via-white to-white/45 bg-clip-text text-[clamp(3.1rem,7vw,6.4rem)] font-black leading-[1.05] tracking-tight text-transparent'
                    >
                    ...
                    <motion.p
                        variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
                        className='font-body mb-10 max-w-xl text-lg leading-relaxed text-white/60'
                    >
                    ...
                    >
                        {/* ✅ Fixed variant type - using 'gradient' instead of 'on-dark' */}
                        <Button
                            variant="gradient"
                            size="lg"
                            className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white"
                        >
                            مشاهده خدمات <ArrowLeft className='h-5 w-5' />
                        </Button>

                        {/* ✅ Fixed variant type - using 'outline' */}
                        <Button
                            variant="outline"
                            size="lg"
                    ...
                    <motion.div
                        ...
                        className='mt-10 flex flex-wrap gap-x-6 gap-y-2 text-sm text-white/40'
                    >
                        <span className='text-white/40'>طراحی برای سازمان‌ها</span>
                        <span className='text-white/20'>·</span>
                        <span className='text-white/40'>امنیت‌محور</span>
                        <span className='text-white/20'>·</span>
                        <span className='text-white/40'>آماده برای بازار فارسی</span>
                    </motion.div>
                </motion.div>
                ...
                >
                    ...
                    <motion.div
                        ...
                        className='holographic-card relative overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.04] p-5 shadow-[0_0_60px_rgba(234,179,8,0.13)] backdrop-blur-xl'
                    >
                        ...
                        <div className='grid gap-4 sm:grid-cols-3'>
                            {metrics.map((metric, index) => (
                                <motion.div
                                    ...
                                    className='rounded-2xl border border-white/[0.08] bg-[#0a0a0a]/80 p-5'
                                >
                        ...
                        <div className='mt-4 rounded-2xl border border-white/[0.08] bg-[#0a0a0a]/80 p-5'>
                            <div className='mb-5 flex items-center justify-between'>
                                ...
                                <motion.span
                                    ...
                                    animate={{ boxShadow: ['0 0 0 rgba(16,185,129,0)', '0 0 24px rgba(16,185,129,0.24)', '0 0 0 rgba(16,185,129,0)'] }}
